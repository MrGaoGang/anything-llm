export function DefaultBadge({ title }) {
  return (
    <>
      ...
      >
        <div className="flex items-center gap-x-1 w-fit rounded-full bg-[#F4FFD0]/10 light:bg-blue-100 px-2.5 py-0.5 text-sm font-medium text-[var(--primary-color)] light:text-theme-text-secondary shadow-sm cursor-pointer">
