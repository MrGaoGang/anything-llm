...
const TRANSLATIONS = {
  ...
  chat_window: {
    ...
    or: "或",
    send_chat: "发送聊天",
    send_message: "给智能助手发送消息",
    attach_file: "向此聊天附加文件",
    slash: "查看所有可用于聊天的斜线命令",
    agents: "查看所有可以用于聊天的代理",
    text_size: "更改文本大小",
    microphone: "语音输入",
    send: "发送",
  },
  profile_settings: {
    edit_account: "账户设置",
    profile_picture: "头像/照片",
    remove_profile_picture: "移除头像/照片",
    username: "用户名称",
    username_description: "用户名称描述",
    new_password: "新密码",
    passwort_description: "密码描述",
    cancel: "取消/退出",
